...
import controllers.BehaviorTreePacMan;
import controllers.NeuralNetworkPacMan;
...
//		best=e.run(100, 20000, 150);
//		System.out.println("Best Individual Fitness:" + best.fitness);
//		Evolution.writeIndividual(best, "IndividualFinal4.ser");
		
		boolean visual=true;
		Controller<MOVE> controller = Evolution.readIndividual("individualFinal4.ser");
//		exec.runGameTimed(controller,new StarterGhosts(),visual);
		exec.runExperiment(controller, new Legacy2TheReckoning(), 1000);
		
		//run multiple games in batch mode - good for testing.
//		int numTrials=10;
//		exec.runExperiment(new BehaviorTreePacMan(),new RandomGhosts(),numTrials);
...
//		boolean visual=true;
//		int delay=10;
//		exec.runGamesTimed(new NearestPillPacMan(),new AggressiveGhosts(),visual);
//		exec.runGameTimed(new StarterPacMan(),new StarterGhosts(),visual);
//		exec.runExperiment(new StarterPacMan(), new RandomGhosts(), 1000);
//		exec.runGame(new BehaviorTreePacMan(),new RandomGhosts(),visual,delay);
//		exec.runGameTimed(new NeuralNetworkPacMan(), new StarterGhosts(), visual);
