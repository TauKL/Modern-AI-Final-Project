...
import pacman.entries.pacman.BehaviorTreePacMan;
import pacman.entries.pacman.NeuralNetworkPacMan;
import pacman.entries.ghosts.MyGhosts;
import pacman.game.Game;
import pacman.game.GameView;
import pacman.dataRecording.*;
...
//		exec.runGameTimed(new StarterPacMan(),new StarterGhosts(),visual);
		exec.runGame(new BehaviorTreePacMan(),new StarterGhosts(),visual,delay);
